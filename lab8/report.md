...
![График для случая 1 Julia](image/01.png){ #fig:001 width=70% height=70% }

![График для случая 2 Julia](image/02.png){ #fig:002 width=70% height=70% }
...
![График для случая 1 OpenModelica](image/03.png){ #fig:003 width=70% height=70% }

![График для случая 2 OpenModelica](image/04.png){ #fig:004 width=70% height=70% }



# Выводы

В ходе выполнения лабораторной работы я изучил модель конкуренции и построил графики в Julia и OpenModelica.
