...
![вариант](image/probl.png){ #fig:000 width=70% height=70% }
...
![траектории для случая 1 (Julia)](image/frst.png){ #fig:002 width=70% height=70% }
...
![траектории для случая 2 (Julia)](image/scnd.png){ #fig:004 width=70% height=70% }
