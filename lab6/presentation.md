...
author: |
	 Любимов Дмитрий Любимов	Нфибд 01-20\inst{1}
...
3.  Построить графики для численности групп
...
В ходе выполнения лабораторной работы я изучил модель $SIR$ и построил графики.
